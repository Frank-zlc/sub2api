export default {
  ...
  admin: {
    ...
    accounts: {
      ...
      anthropicAwsHint: 'Anthropic 在 AWS 上颁发的 API Key（以 AEAA 开头），通过 x-api-key 传递。粘贴后请核对下方末 4 位避免 5/S、0/O 视觉混淆',
      ...
      anthropicAwsRegionPlaceholder: '例如 us-east-1',
      anthropicAwsRegionHint: '用于拼接 Base URL：https://api.{region}.aws.anthropic.com',
      anthropicAwsBaseUrlHint: '留空时根据 Region 自动生成；填写后 Region 仅作备注',
      anthropicAwsApiKeyRequired: '请输入 Claude Platform on AWS API Key',
