export default {
  ...
  admin: {
    ...
    accounts: {
      ...
      anthropicAwsHint: 'API Key issued by Anthropic on AWS (starts with AEAA), passed via x-api-key header. After pasting, verify the last 4 chars to avoid 5/S, 0/O visual confusion',
      anthropicAwsApiKeyPlaceholder: 'AEAA...',
      anthropicAwsWorkspaceIdLabel: 'Workspace ID',
      anthropicAwsWorkspaceIdPlaceholder: 'wrkspc_...',
      anthropicAwsWorkspaceIdHint: 'Starts with wrkspc_, passed via anthropic-workspace-id header (required, otherwise upstream returns 400)',
      anthropicAwsRegionLabel: 'AWS Region',
      anthropicAwsRegionPlaceholder: 'e.g. us-east-1',
      anthropicAwsRegionHint: 'Used to construct Base URL: https://api.{region}.aws.anthropic.com',
      anthropicAwsBaseUrlHint: 'Leave empty to auto-generate from Region; if filled, Region is for reference only',
      anthropicAwsApiKeyRequired: 'Please enter the Claude Platform on AWS API Key',
